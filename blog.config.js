...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '加六Jaleel', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '@0xJaleel_eth，Nonsense Poster at @BlockBeatsAsia / Perp degen / Bullish @edgeX_exchange / 我说的仅代表我自己', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://tangly1024.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'web3知识分享', // 网站关键词 英文逗号隔开
